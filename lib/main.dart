...
//   Plant({required this.name, required this.modelId, required this.icon});
// }

// final List<Plant> plants = [
//   Plant(name: "Tomato", modelId: "model1", icon: Icons.spa), // Example icon
//   Plant(name: "Potato", modelId: "model2", icon: Icons.eco),
//   Plant(name: "Grape", modelId: "model3", icon: Icons.grass),
//   Plant(name: "Corn", modelId: "model4", icon: Icons.grain),
// ];
...
//                     SizedBox(height: 8),
//                     Text(
//                       'Select a plant to begin diagnosis.',
//                       style: TextStyle(fontSize: 18, color: Colors.black54),
//                     ),
//                   ],
//                 ),
...
//   Widget build(BuildContext context) {
//     return Scaffold(
//       appBar: AppBar(title: Text('${widget.plant.name} Diagnosis')),
//       body: SingleChildScrollView(
//         padding: const EdgeInsets.all(24.0),
//         child: Column(
//           children: <Widget>[
//             _buildImagePicker(),
//             const SizedBox(height: 24),
//             if (_image != null && !_isLoading) _buildDiagnoseButton(),
//             const SizedBox(height: 30),
//             _buildResult(),
//           ],
//         ),
...
//       );
//     if (_predictionResult != null)
//       return ResultCard(result: _predictionResult!);
//     return const SizedBox.shrink();
//   }
// }
